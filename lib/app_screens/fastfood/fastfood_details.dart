                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Image.network(
                        fastFoodNotifier.currentFood.image != null
                            ? fastFoodNotifier.currentFood.image
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              fastFoodNotifier.currentFood.name,
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.w500),
                            ),
                            Text(
                              '\$${fastFoodNotifier.currentFood.price}',
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.w500),
                            ),
                          ],
                        ...
                        ExpandablePanel(
                          ...
                          expanded: Text(
                            fastFoodNotifier.currentFood.description,
                            style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            SmoothStarRating(
                              ...
                              size: 16,
                              rating: double.parse(
                                  fastFoodNotifier.currentFood.rating),
