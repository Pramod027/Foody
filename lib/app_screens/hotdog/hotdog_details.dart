                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Image.network(
                        hotDogNotifier.currentFood.image != null
                            ? hotDogNotifier.currentFood.image
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              hotDogNotifier.currentFood.name,
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.w500),
                            ),
                            Text(
                              '\$${hotDogNotifier.currentFood.price}',
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.w500),
                            ),
                          ],
                        ...
                        ExpandablePanel(
                          ...
                          expanded: Text(
                            hotDogNotifier.currentFood.description,
                            style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            SmoothStarRating(
                              ...
                              size: 16,
                              rating: double.parse(
                                  hotDogNotifier.currentFood.rating),
